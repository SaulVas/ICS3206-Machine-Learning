...
if __name__ == "__main__":
    ...
    try:
        combined_pattern = ["./data/augmented/combined/*.jpg"]
        results = evaluate_templates(combined_pattern, template_paths, is_combined=True)
        all_results["combined_augmentations"] = results
    except ValueError as e:
